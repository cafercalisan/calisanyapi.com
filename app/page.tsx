...
const inspirations = [
  ...
  { src: "/services/lifestyle/balkon-yasam-ferah.png", title: "Balkonda yeni bir yaşam alanı", label: "Cam balkon · Açık ton" },
];
