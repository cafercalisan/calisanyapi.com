...
export const metadata: Metadata = { title: "Ücretsiz Keşif ve Yaklaşık Teklif Al", description: "İhtiyacınız olan yapı hizmetini seçin; yaklaşık ölçü ve alan fotoğraflarını paylaşın. Ekibimiz ön değerlendirme için sizinle iletişime geçsin.", alternates: { canonical: "/teklif-al" } };
