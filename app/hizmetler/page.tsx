...
export const metadata: Metadata = { title: "PVC Kapı Pencere ve Yapı Sistemleri İstanbul", description: "İstanbul'da PVC kapı-pencere, cam balkon, sineklik, kış bahçesi, pergola, korkuluk ve asma tavan için keşif ve uygulama seçeneklerini inceleyin.", alternates: { canonical: "/hizmetler" } };
