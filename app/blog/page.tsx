...
export const metadata: Metadata = { title: "PVC Pencere, Cam Balkon ve Yapı Rehberi", description: "PVC pencere, cam balkon ve sineklik seçerken ölçü, malzeme, yalıtım ve montaj kararlarını kolaylaştıran uygulamaya dönük rehberleri okuyun.", alternates: { canonical: "/blog" } };
