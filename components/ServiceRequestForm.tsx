...
const galleries: Record<string, GalleryItem[]> = {
  ...
  "cam-balkon": [{ src: "/services/cam-balkon-v2.png", alt: "Üst ve alt raylı, yana katlanan dikey profilsiz cam balkon sistemi", tone: "Katlanır sistem · Antrasit" }, { src: "/services/cam-balkon.png", alt: "Katlanmış cam panelleri görünen cam balkon", tone: "Panel detayı · Şeffaf cam" }, { src: "/brand/calisan-yapi-hero.png", alt: "Konut terasında cam kapama sistemi", tone: "Teras kapama · Mimari uyum" }],
  kupeste: [{ src: "/services/kupeste-v2.png", alt: "Kesintisiz tutamaklı paslanmaz merdiven küpeştesi", tone: "Paslanmaz · Doğal taş" }, { src: "/services/kupeste.png", alt: "İç mekânda paslanmaz küpeşte uygulaması", tone: "Yuvarlak hat · İç mekân" }, { src: "/services/lifestyle/kupeste-01.jpg", alt: "Taş merdivende metal küpeşte detayı", tone: "Metal · Gün ışığı" }, { src: "/services/lifestyle/kupeste-02.jpg", alt: "Modern mimaride geometrik küpeşte", tone: "Beyaz · Grafik çizgi" }],
  korkuluk: [{ src: "/services/korkuluk-v2.png", alt: "Taban kanalına oturan lamine cam teras korkuluğu", tone: "Cam korkuluk · Taban kanal" }, { src: "/services/korkuluk.png", alt: "Postalı cam korkuluk ve merdiven bağlantısı", tone: "Antrasit posta · Şeffaf cam" }, { src: "/services/lifestyle/cam-korkuluk-01.jpg", alt: "Açık havada cam korkuluklu teras", tone: "Cam · Açık teras" }],
  "asma-tavan": [{ src: "/services/asma-tavan-v2.png", alt: "Taşıyıcı ritmi ve erişim paneli görünen lineer metal asma tavan", tone: "Metal baffle · Sıcak ışık" }, { src: "/services/asma-tavan.png", alt: "Lineer baffle asma tavanlı modern iç mekân", tone: "Antrasit baffle · Oturma alanı" }, { src: "/services/lifestyle/asma-tavan-01.jpg", alt: "Özgün tavan tasarımlı çağdaş ofis", tone: "Modüler tavan · Ofis" }],
  sineklik: [{ src: "/services/sineklik-v2.png", alt: "İnce alt kılavuzlu antrasit plise kapı sinekliği", tone: "Plise · Antrasit" }, { src: "/products/pliseli-kapi.jpg", alt: "Elle açılan plise kapı sinekliği", tone: "Plise kapı · Kullanım detayı" }, { src: "/products/lifestyle-kapi-plise.jpg", alt: "Yaşam alanında plise kapı sinekliği", tone: "Plise kapı · Yaşam alanı" }, { src: "/products/lifestyle-pencere-plise.jpg", alt: "Modern pencerede plise sineklik", tone: "Plise pencere · Beyaz" }],
};
...
export function ServiceRequestForm({ initialService, initialDistrict }: { initialService?: string; initialDistrict?: string }) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      track("lead_success", { service: selectedService, district: String(form.get("district") || ""), event_id: result.eventId });
